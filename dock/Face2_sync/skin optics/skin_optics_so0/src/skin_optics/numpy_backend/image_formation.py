...
def spectral_radiance(
    ...
    _check_factor("shading", shading, 0.0, 2.5)
    _check_factor("specular", specular, 0.0, 0.20)
    _check_factor("exposure", exposure, 0.1, 3.0)
...
def render_cie_reference(
    ...
    rad = spectral_radiance(assets, reflectance, illuminant_name, shading, specular, exposure)
