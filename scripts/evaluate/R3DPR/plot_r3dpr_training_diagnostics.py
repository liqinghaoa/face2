"""Create per-fold two-panel training diagnostics for the R3DPR baseline."""
...
OUTPUT_SUBDIR = "figures/overfit_diagnostics"
...
def write_report(output_dir: Path, summary: pd.DataFrame) -> None:
    ...
    report = f"""# R3DPR training diagnostic figures
